...
●　語学教室を投稿・開催するのが外国人の方のケースを想定し、不自然な翻訳になるGoogle翻訳でなく、意訳を自由にJSONファイルへ設定できるプラグインvuei18nを使用して英語にも切替可能にしました。

●　様々なカテゴリーから投稿を絞り込めるようにして高いユーザービリティを心がけました。


いいね、参加登録、自分の投稿に絞り込みできます。<br>
